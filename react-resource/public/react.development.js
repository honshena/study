...
var ReactNoopUpdateQueue = {
   ...
   * @internal
   */
  enqueueSetState: function (publicInstance, // class组件的this
  partialState, callback, callerName) {
...
var ReactSharedInternals = {
  ReactCurrentDispatcher: ReactCurrentDispatcher, // hook的dispatcher
...
function createElement(type, config, children) {
  ...
  if (config != null) {
    ...
    for (propName in config) {
      if (hasOwnProperty$1.call(config, propName) && //note: hasOwnProperty
...
function getPooledTraverseContext(mapResult, //存储遍历结果
keyPrefix, //前缀
...
function traverseAllChildrenImpl(children, nameSoFar, callback, traverseContext) {
  ...
  var invokeCallback = false; //是否为单个节点
  //单个节点判断
  if (children === null) {
    invokeCallback = true;
  } else {
...
function forwardRef(render) {
  ...
  return {
    ...
    render: render //函数组件(props,ref)=>{组件}
  };
}
